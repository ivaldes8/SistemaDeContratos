...
class ObjSupCEController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('objSupCE.index', compact('objeto'));
    }
    ...
    {
        $objeto = 'none';
        return view('objSupCE.edit', compact('objeto'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/objsupce')->with('status', 'Objeto de suplemento creado satisfactoriamente');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/objsupce')->with('status', 'Objeto de suplemento Editado satisfactoriamente');
    }

    public function delete($id)
    {
        $objeto = objSupCE::find($id);
        return view('objSupCE.delete', compact('objeto'));
    }
