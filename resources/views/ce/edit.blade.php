...
@section('content')
    <div class="container mt-3">
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-6 mt-1 d-flex justify-content-start">
                        {{ $supcm === 'none' ? 'Crear Suplemento' : 'Editar Suplemento' }}
                    </div>
            ...
            <div class="card-body">
                @if ($supcm === 'none')
                    <form action="{{ url('supcm/' . $id) }}" method="POST">
                    @else
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="noSuplemento" class="form-control"
                        value="{{ $supcm !== 'none' ? $supcm->noSupCM : '' }}" disabled>
                ...
                <div class="form-group mb-3">
                    ...
                    <select name="objeto_id[]" multiple="multiple" class="form-control objetoSelect">
                        ...
                        @foreach ($objetos as $item)
                            <option
                                {{ $supcm !== 'none' && !!$supcm->objetos->where('id', $item->id)->first() ? 'selected' : '' }}
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="ejecutor" class="form-control"
                        value="{{ $supcm !== 'none' ? $supcm->ejecutor : '' }}">
                    ...
                    <div class="col-6">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="fechaIni" class="form-control date"
                                value="{{ $supcm !== 'none' ? $supcm->fechaIni : '' }}" id="picker1">
                    ...
                    <div class="col-6">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="fechaEnd" class="form-control date"
                                value="{{ $supcm !== 'none' ? $supcm->fechaEnd : '' }}" id="picker2">
                ...
                <div class="form-group mb-3 d-flex justify-content-end">
                    <button class="btn btn-primary" type="submit">{{ $supcm === 'none' ? 'Crear' : 'Editar' }}</button>
                </div>
                </form>
            </div>
        </div>
