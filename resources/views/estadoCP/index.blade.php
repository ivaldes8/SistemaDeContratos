            ...
            <div class="card-header">
                <div class="row">
                    <div class="col-9 mt-1 d-flex justify-content-start">
                        Estados de Contratos Proveedores
                    </div>
                    <div class="col-3 d-flex justify-content-end">
                        <a href="{{ url('estadocp/create') }}" class="btn btn-primary"><i class="bi bi-plus-circle"></i></a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <form action="{{ url('estadocp') }}" method="get">
                    <div class="row">
                        ...
                        <div class="col-3 d-flex justify-content-end">
                            <a href="{{ url('estadocp') }}" class="btn btn-sm btn-primary"><i class="bi bi-arrow-repeat"></i></a>
