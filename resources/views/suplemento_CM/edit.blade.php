        ...
        @endif
            <div class="card">
                <div class="card-header">
                    <h4>Editar Suplemento de Contrato Marco
                ...
                <div class="card-body">
                    <form action="{{url('suplementocm/'.$Sup[0]->id)}}" method="POST">
                        @csrf
                        @method('PUT')
                                    ...
                                    <div class="col-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <select class="col-8" style="border: solid 1px;" id="objeto" name="noContrato">
                                                    <option value = '{{$Sup[0]->CMs->id}}'>{{$Sup[0]->CMs->noContrato}}</option>
                                            </select>
                                            <p class="mt-3">Objeto del Contrato: {{$Sup[0]->CMs->objeto}}</p>
                                            <p>Organismo: {{$Sup[0]->CMs->organismos->nombreO}}</p>
                                            <p>Entidad: {{$Sup[0]->CMs->cliente->nombre}}</p>
