            ...
            <div class="card-header">
                <div class="row">
                    <div class="col-9 mt-1 d-flex justify-content-start">
                        Tipos de Contratos Proveedores
                    </div>
                    <div class="col-3 d-flex justify-content-end">
                        <a href="{{ url('tipocp/create') }}" class="btn btn-primary"><i class="bi bi-plus-circle"></i></a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <form action="{{ url('tipocp') }}" method="get">
                    <div class="row">
                        ...
                        <div class="col-3 d-flex justify-content-end">
                            <a href="{{ url('tipocp') }}" class="btn btn-sm btn-primary"><i class="bi bi-arrow-repeat"></i></a>
                ...
                <div class="table-responsive">
                    <table class="table table-primary table-bordered table-striped">
                        ...
                        <tbody>
                            @if (count($tipo) < 1)
                                <tr>
                                    <td class="text-center" colspan="7">No se encontraron tipos</td>
                                </tr>
                            @else
